...
/// Purpose: Behavior for windows closing
#region ========================================================================= USING =====================================================================================
using System;
using Avalonia;
using Avalonia.Data;
...
{
    public class CloseBehavior : AvaloniaObject
    {
        ...
        public static readonly AttachedProperty<string> CommandProperty = AvaloniaProperty.RegisterAttached<CloseBehavior, Interactive, string>(
        ...
        public static readonly AttachedProperty<object> CommandParameterProperty = AvaloniaProperty.RegisterAttached<CloseBehavior, Interactive, object>(
        ...
        /// </summary>
        /// <param name="element">The UI element that initiated the close command</param>
