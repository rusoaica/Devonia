...
namespace Devonia.Views.Common.Styles
{
    public sealed class StyleManager
    {
        #region ============================================================== FIELD MEMBERS ================================================================================
        private readonly Application application;
        private readonly StyleInclude darkStyle = CreateStyle("avares://Devonia/Common/Styles/Dark.xaml");
        private readonly StyleInclude lightStyle = CreateStyle("avares://Devonia/Common/Styles/Light.xaml");
        #endregion
        ...
        {
            return new StyleInclude(new Uri("resm:Styles?assembly=Devonia"))
            {
                Source = new Uri(url)
            };
        }
